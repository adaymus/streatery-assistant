...
function titleBlock(
  ...
  return [
    ...
    `<text x="4" y="57" font-size="3.5" font-family="sans-serif" font-style="italic" fill="#a8a29e">For meeting discussion; PE stamp + architect refinement required before submission</text>`,
    `</g>`,
  ].join("\n");
}
